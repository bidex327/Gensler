      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              <span className="text-xs font-semibold uppercase tracking-[3px] text-red-700">
                Blog
              </span>
              <h1 className="mt-4 text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-gray-900 hover:text-red-700 transition duration-300">
                Design as Storytelling:
                <br />
                How AI Is Transforming the Way We Imagine, Create and Connect
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="mt-4 text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-gray-900 hover:text-red-700 transition duration-300">
