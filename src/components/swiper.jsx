...
const slides = [
  {
    ...
    button: "Learn More",
    titleClass:
      "text-3xl font-bold italic leading-tight text-white sm:text-5xl lg:text-7xl",
    descriptionClass:
...

  {
    ...
    description:
      "Explore Gensler's newest survey of urbanites in 65 cities around the world.",
    button: "Learn More",
    titleClass:
      "text-3xl font-bold italic leading-tight text-white sm:text-5xl lg:text-6xl",
    descriptionClass:
...

  {
    ...
    description:
      "Explore a new design for a hospital that adapts to its community over time.",
    button: "Discover",
    titleClass:
      "text-3xl sm:text-5xl lg:text-6xl font-bold italic leading-tight text-white",
    descriptionClass:
...

  {
    ...
    description:
      "The GPS Standards™ are recognized for helping the industry adopt more regenerative materials.",
    button: "Learn More",
    titleClass:
      "text-3xl sm:text-5xl lg:text-6xl font-bold italic leading-tight text-white",
    descriptionClass:
...

  {
    ...
    description:
      "Discover emerging design trends shaping the future of cities, workplaces, hospitality and innovation.",
    button: "Learn More",
    titleClass:
      "text-4xl sm:text-6xl lg:text-7xl font-bold italic leading-tight text-white",
    descriptionClass:
      "max-w-2xl text-base sm:text-lg lg:text-xl leading-7 text-gray-200",
    width: "max-w-3xl",
  },
          ...
          >
            ...
            <div className={contentStyle}>
              <div className={slide.width}>
                <h1 className={slide.titleClass}>
                  {slide.title}
                </h1>

                <BsDashLg className="my-5 text-5xl text-amber-400" />

                <p className={slide.descriptionClass}>
                  {slide.description}
                </p>
