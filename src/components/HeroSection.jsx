...
const HeroSection = () => {
  return (
    <section id="hero-section" className="bg-black text-white py-16 sm:py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="max-w-4xl">
          ...
          <button className="mt-10 border-2 border-white px-8 py-4 rounded-md font-semibold tracking-wide transition-all duration-300 hover:bg-red-700 hover:border-red-700 w-full sm:w-auto">
